...
public class Health : MonoBehaviour
{
    ...
    void AlterarTransparenciaDoPainel(float alpha)
    {
        if (panelDamage != null)
        {
            ...
            Debug.Log("Transpar�ncia alterada com sucesso!");
        }
        else
        {
            Debug.LogError("O objeto Image n�o foi atribu�do ao script!");
        }
    }
    IEnumerator PiscarTela()
    {
        // Torna o painel vis�vel e define a cor de piscar
